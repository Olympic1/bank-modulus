 ...
 */
final class DataV890 implements DataInterface
{
    /** @internal */
    final public function fetchRecord($sortCode, $pass)
    {
        ...
        if (
            (
                ...
                && (
                    ...
                    || ('040335' <= $sortCode && $sortCode <= '040339')
                    || ('043926' <= $sortCode && $sortCode <= '043935')
                    || '185003' === $sortCode
        ...
        if (
            ...
            && (
                ...
                || ('044010' <= $sortCode && $sortCode <= '044059')
                || '090013' === $sortCode
                || '090105' === $sortCode
                || ('090120' <= $sortCode && $sortCode <= '090125')
        ...
        if (
            ...
            return ['MOD11', [6, 5, 4, 3, 2, 1, 8, 7, 6, 5, 4, 3, 2, 1], 0];
        }
        ...
        if (
            ...
            return ['MOD11', [0, 0, 0, 0, 0, 0, 9, 7, 6, 4, 3, 2, 2, 1], 0];
        }
        ...
        if (
            ...
            && (
                ...
                || ('304078' <= $sortCode && $sortCode <= '304086')
            )
        ) {
